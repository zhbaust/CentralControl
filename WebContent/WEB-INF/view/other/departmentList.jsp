	...
	$(function() {	
	    ...
	    $('#dataList').datagrid({ 
	        ...
	        columns: [[  
 		       ...
 		       {field:'address',title:'部门地址',width:200},
	    	...
	    	buttons: [
				{
					...
					handler:function(){
						...
						if(!validate){
							...
							var address = $("#edit_address").textbox("getText");
							var remark = $("#edit_remark").textbox("getText");
							
							var data = {id:id,name:name,address:address,remark:remark};
							
							$.ajax({
								type: "post",
								url: "DepartmentServlet?method=editDepartment",
								data: data,
								success: function(msg){
									if(msg == "success"){
	...
	<div id="addDialog" style="padding: 10px">  
    	<form id="addForm" method="post">
	    	<table cellpadding="8" >
	    		...
	    		<tr>
	    			<td>部门地址:</td>
	    			<td><input id="add_address" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="address" data-options="required:true, validType:'repeat_course', missingMessage:'不能为空'" /></td>
	    		</tr>
	    		<tr>
	    			<td>部门备注:</td>
	    			<td><input id="add_remark" style="width: 200px; height: 30px;" class="easyui-textbox" type="text" name="remark" data-options="required:true, validType:'repeat_course', missingMessage:'不能为空'" /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
