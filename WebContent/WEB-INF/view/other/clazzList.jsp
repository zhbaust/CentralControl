	    ...
	    $("#query").click(function(){
        	...
        	if(name == null){
            	$.messager.alert("消息提醒", "请输入要查询的班级名称", "warning");
            			...
            			$.ajax({
							type: "post",
							url: "ClazzServlet?method=ClazzListByName",
							data: {name: name},
							dataType:"json",
...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left;" class="datagrid-btn-separator"></div>
		<div style="float: left;">年级：<input id="gradeList" class="easyui-textbox" name="grade" /></div>
		<div style="float: left;" class="datagrid-btn-separator"></div>
		<div style="float: left;">班级：<input id="clazznameList" class="easyui-textbox" name="clazzname" /></div>
		<div style="margin: 0 10px 0 10px"><a id="query" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true">查询</a></div>
	</div>
