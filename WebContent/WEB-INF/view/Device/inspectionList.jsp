		...
		//datagrid初始化 
	     $('#dataList').datagrid({ 
	    	 title:'巡检记录列表', 
		        ...
		        fit: true,//自动大小 
		        method: "post",
		        url:"InspectionServlet?method=InspectionList&t="+new Date().getTime(),
		        idField:'id', 
		        ...
		        columns: [[  
	 		       ...
	 		       {field:'device',title:'设备名',width:100, 
	 		        ...
	 		        {field:'routetime',title:'巡检时间',width:200},
	 		       {field:'dispose',title:'巡检处理',width:300},
	    ...
	    //删除
	     $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "将删除与巡检记录相关的所有数据，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "InspectionServlet?method=DeleteInspection",
							data: {ids: ids},
		    	...
		    	buttons: [
		    		{
						...
						handler:function(){
							...
							if(!validate){
								...
								$.ajax({
									type: "post",
									url: "InspectionServlet?method=AddInspection&t="+new Date().getTime(),
									...
									success: function(msg){
										if(msg == "success"){
											...
											$("#add_routetime").textbox('setValue', "");
		    ...
		    $("#editDialog").dialog({
		    	...
		    	buttons: [
		    		{
						...
						handler:function(){
							...
							if(!validate){
								...
								$.ajax({
									type: "post",
									url: "InspectionServlet?method=EditInspection&t="+new Date().getTime(),
					...
					},
					{
						...
						handler:function(){
							//清空表单
							$("#edit_routetime").textbox('setValue', "");
				...
				onBeforeOpen: function(){
					...
					//设置值
							...
							$("#edit_routetime").textbox('setValue', selectRow.routetime);	 
...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left; margin: 0 5px 0 5px">巡检处理：<input id="dispose" class="easyui-textbox" name="dispose" /></div>
	...
	<div id="addDialog" style="padding: 10px">
    	<form id="addForm" method="post">
	    	<table cellpadding="2" >
	    		...
	    		<tr>
	    			<td>巡检日期:</td>
	    			<td><input id="add_routetime" style="width: 200px; height: 25px;" class="easyui-datetimebox" type="text" name="routetime" data-options="required:true, missingMessage:'请填写巡检日期'" /></td>
	    		</tr>
	    		<tr>
	    			<td>巡检人员:</td>
	    		...
	    		<tr>
	    			<td>巡检处理:</td>
	    			<td><input id="add_dispose" style="width: 200px; height: 75px;" class="easyui-textbox" type="text"  name="dispose"  data-options="multiline: true," data-options="required:true, missingMessage:'请填写巡检日期'"  /></td>
	    		</tr>
	    		<tr>
	    			<td>备注:</td>
	...
	<div id="editDialog" style="padding: 10px">
    	<form id="editForm" method="post">
	    	<table cellpadding="2" >
	    		...
	    		<tr>
	    			<td>巡检日期:</td>
	    			<td><input id="edit_routetime" style="width: 200px; height: 25px;" class="easyui-datetimebox" type="text" name="routetime" data-options="required:true, missingMessage:'请填写巡检日期'" /></td>
	    		</tr>
	    		<tr>
	    			<td>巡检人员:</td>
	    		...
	    		<tr>
	    			<td>巡检处理:</td>
	    			<td><input id="edit_dispose" style="width: 200px; height: 75px;" class="easyui-textbox" type="text"  name="dispose"  data-options="multiline: true," data-options="required:true, missingMessage:'请填写巡检日期'"  /></td>
	    		</tr>
	    		<tr>
	    			<td>备注:</td>
