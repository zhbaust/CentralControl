	...
	$(function() {	
		//datagrid初始化 
	     $('#dataList').datagrid({ 
	    	 title:'维护计划列表', 
		        ...
		        fit: true,//自动大小 
		        method: "post",
		        url:"MaintenanceplanServlet?method=MaintenanceplanList&t="+new Date().getTime(),
		        idField:'id', 
		        ...
		        columns: [[  
	 		       ...
	 		       {field:'device',title:'设备名',width:100, 
	 		        ...
	 		        {field:'maintenanceinterval',title:'维护周期(天)',width:80},
	 		       ...
	 		       {field:'content',title:'维护内容',width:300},
	 		      {field:'remindtime',title:'提醒时间',width:200},
	    ...
	    //删除
	     $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "将删除与维护计划相关的所有数据，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "MaintenanceplanServlet?method=DeleteMaintenanceplan",
							data: {ids: ids},
	   ...
	   //查询
	     $("#query").click(function(){
	    	...
	    	var page =1;
	    	var rows=10;
	    	var data = {deviceid:deviceid,operatorid:operatorid,content:content,starttime:starttime,endtime:endtime,page:page,rows:rows};
	    	//alert(name);
        	/* if(name == null){
		    	...
		    	buttons: [
		    		{
						...
						handler:function(){
							...
							if(!validate){
								...
								$.ajax({
									type: "post",
									url: "MaintenanceplanServlet?method=AddMaintenanceplan&t="+new Date().getTime(),
									...
									success: function(msg){
										if(msg == "success"){
											...
											$("#add_remindtime").textbox('setValue', "");	
		    ...
		    $("#editDialog").dialog({
		    	...
		    	buttons: [
		    		{
						...
						handler:function(){
							...
							if(!validate){
								...
								$.ajax({
									type: "post",
									url: "MaintenanceplanServlet?method=EditMaintenanceplan&t="+new Date().getTime(),
					...
					},
					{
						...
						handler:function(){
							...
							$("#edit_interval").textbox('setValue', "");
							
							var data = $("#edit_operatorList").combobox("getData");
							$("#edit_operatorList").combobox("setValue", data[0].id);
							$("#edit_content").textbox('setValue', "");	
							$("#edit_remindtime").textbox('setValue', "");	
				...
				onBeforeOpen: function(){
					...
					//设置值
						    ...
						    $("#edit_interval").textbox('setValue', selectRow.maintenanceinterval);
							$("#edit_operatorList").combobox("setValue",selectRow.operator.id);
							$("#edit_content").textbox('setValue', selectRow.content);
							$("#edit_remindtime").textbox('setValue', selectRow.remindtime);	
...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left; margin: 0 5px 0 5px">维护内容：<input id="content" style="width: 100px; height: 25px;" class="easyui-textbox" name="content" /></div>
		<div style="float: left; margin: 0 5px 0 5px">提醒日期：<input id="starttime" style="width: 150px; height: 25px;" class="easyui-datetimebox" name=""starttime"" /></div>
		<div style="float: left; margin: 0 5px 0 5px">至<input id="endtime" style="width: 150px; height: 25px;" class="easyui-datetimebox" name="endtime" /></div>
	...
	<div id="addDialog" style="padding: 10px">
    	<form id="addForm" method="post">
	    	<table cellpadding="2" >
	    		...
	    		<tr>
	    			<td>维护周期(天):</td>
	    			<td><input id="add_interval" style="width: 200px; height: 25px;" class="easyui-textbox" type="text"  name="maintenanceinterval"   data-options="required:true, missingMessage:'请填写维护周期'"  /></td>
	    		</tr>
	    		<tr>
	    			<td>维护人员:</td>
	    		...
	    		<tr>
	    			<td>维护内容:</td>
	    			<td><input id="add_content" style="width: 200px; height: 75px;" class="easyui-textbox" type="text"  name="content"  data-options="multiline: true," data-options="required:true, missingMessage:'请填写维护内容'"  /></td>
	    		</tr>
	    		<tr>
	    			<td>提醒日期:</td>
	    			<td><input id="add_remindtime" style="width: 200px; height: 25px;" class="easyui-datetimebox" type="text" name="remindtime" data-options="required:true, missingMessage:'请填写维护提醒日期'" /></td>
	    		</tr>
	    		<tr>
	    			<td>备注:</td>
	...
	<div id="editDialog" style="padding: 10px">
    	<form id="editForm" method="post">
	    	<table cellpadding="2" >
	    		...
	    		<tr>
	    			<td>维护周期(天):</td>
	    			<td><input id="edit_interval" style="width: 200px; height: 25px;" class="easyui-textbox" type="text"  name="maintenanceinterval"   data-options="required:true, missingMessage:'请填写维护周期'"  /></td>
	    		</tr>
	    		<tr>
	    			<td>维护人员:</td>
	    		...
	    		<tr>
	    			<td>维护内容:</td>
	    			<td><input id="edit_content" style="width: 200px; height: 75px;" class="easyui-textbox" type="text"  name="content"  data-options="multiline: true," data-options="required:true, missingMessage:'请填写维护内容'"  /></td>
	    		</tr>
	    		<tr>
	    			<td>提醒日期:</td>
	    			<td><input id="edit_remindtime" style="width: 200px; height: 25px;" class="easyui-datetimebox" type="text" name="remindtime" data-options="required:true, missingMessage:'请填写维护提醒日期'" /></td>
	    		</tr>
	    		<tr>
	    			<td>备注:</td>
