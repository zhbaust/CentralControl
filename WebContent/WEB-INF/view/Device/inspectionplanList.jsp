	...
	$(function() {	
		//datagrid初始化 
	     $('#dataList').datagrid({ 
	    	 title:'巡检计划列表', 
		        ...
		        fit: true,//自动大小 
		        method: "post",
		        url:"InspectionplanServlet?method=InspectionplanList&t="+new Date().getTime(),
		        idField:'id', 
		        ...
		        columns: [[  
	 		       ...
	 		       {field:'device',title:'设备名',width:100, 
	 		        ...
	 		        {field:'inspectioninterval',title:'巡检周期(天)',width:80},
	 		       {field:'operator',title:'巡检人员',width:100, 
	 		        	formatter: function(value,row,index){
	 						if (row.operator){
	 		       ...
	 		       {field:'content',title:'巡检内容',width:300},
		 		]], 
		        toolbar: "#toolbar",
	    ...
	    //删除
	     $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "将删除与巡检计划相关的所有数据，确认继续？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "InspectionplanServlet?method=DeleteInspectionplan",
							data: {ids: ids},
	   ...
	   //查询
	     $("#query").click(function(){
	    	...
	    	var page =1;
	    	var rows=10;
	    	var data = {deviceid:deviceid,operatorid:operatorid,content:content,page:page,rows:rows};
	    	//alert(name);
        	/* if(name == null){
		    	...
		    	buttons: [
		    		{
						...
						handler:function(){
							...
							if(!validate){
								...
								$.ajax({
									type: "post",
									url: "InspectionplanServlet?method=AddInspectionplan&t="+new Date().getTime(),
		    ...
		    $("#editDialog").dialog({
		    	...
		    	buttons: [
		    		{
						...
						handler:function(){
							...
							if(!validate){
								...
								$.ajax({
									type: "post",
									url: "InspectionplanServlet?method=EditInspectionplan&t="+new Date().getTime(),
				...
				onBeforeOpen: function(){
					...
					//设置值
						    ...
						    $("#edit_interval").textbox('setValue', selectRow.inspectioninterval);
...
<body>
	...
	<div id="toolbar">
		...
		<div style="float: left; margin: 0 5px 0 5px">巡检人员：<input id="operatorList" class="easyui-textbox" name="operator" /></div>
		<div style="float: left; margin: 0 5px 0 5px">巡检内容：<input id="content" style="width: 100px; height: 25px;" class="easyui-textbox" name="content" /></div>
	...
	<div id="addDialog" style="padding: 10px">
    	<form id="addForm" method="post">
	    	<table cellpadding="2" >
	    		...
	    		<tr>
	    			<td>巡检周期(天):</td>
	    			<td><input id="add_interval" style="width: 200px; height: 25px;" class="easyui-textbox" type="text"  name="inspectioninterval"   data-options="required:true, missingMessage:'请填写巡检周期'"  /></td>
	    		</tr>
	    		<tr>
	    			<td>巡检人员:</td>
	    		...
	    		<tr>
	    			<td>巡检内容:</td>
	    			<td><input id="add_content" style="width: 200px; height: 75px;" class="easyui-textbox" type="text"  name="content"  data-options="multiline: true," data-options="required:true, missingMessage:'请填写巡检内容'"  /></td>
	    		</tr>
	...
	<div id="editDialog" style="padding: 10px">
    	<form id="editForm" method="post">
	    	<table cellpadding="2" >
	    		...
	    		<tr>
	    			<td>巡检周期(天):</td>
	    			<td><input id="edit_interval" style="width: 200px; height: 25px;" class="easyui-textbox" type="text"  name="inspectioninterval"   data-options="required:true, missingMessage:'请填写巡检周期'"  /></td>
	    		</tr>
	    		<tr>
	    			<td>巡检人员:</td>
	    		...
	    		<tr>
	    			<td>巡检内容:</td>
	    			<td><input id="edit_content" style="width: 200px; height: 75px;" class="easyui-textbox" type="text"  name="content"  data-options="multiline: true," data-options="required:true, missingMessage:'请填写巡检内容'"  /></td>
	    		</tr>
