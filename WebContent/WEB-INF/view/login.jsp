...
<title>登录|中控管理系统</title>
<meta name="keywords" content="中控管理系统">
</head>
<body>

<div class="header" style="padding: 0;">
	<h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">中控管理系统</h2>
</div>
    ...
    <form id="form" class="form form-horizontal" method="post">
      <div class="row cl">
        ...
        <div class="formControls col-8">
          <input id="" name="account" type="text" placeholder="账户" class="input-text size-L" value="admin">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-3"><i class="Hui-iconfont">&#xe60e;</i></label>
        <div class="formControls col-8">
          <input id="" name="password" type="password" placeholder="密码" class="input-text size-L" value="123456">
        </div>
      </div>
      <div class="row cl"> 
        <div class="formControl col-8 col-offset-3">
...
<div class="footer">Copyright &nbsp; zhb @  </div>
